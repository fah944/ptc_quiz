...
class _$DepartmentImpl with DiagnosticableTreeMixin implements _Department {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Department(deptId: $deptId, name: $name, manager: $manager, budget: $budget, meeting_time: $meeting_time, year: $year, availability: $availability)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, deptId, name, manager, budget,
      meeting_time, year, availability);
...
abstract class _Department implements Department {
  const factory _Department(
      ...
      final int? year,
      final Availability? availability}) = _$DepartmentImpl;
